...
namespace Tvl.Collections.Trees
{
    ...
    {
        public TreeDictionary() => throw null;

        public TreeDictionary(IEnumerable<KeyValuePair<TKey, TValue>> collection) => throw null;

        public TreeDictionary(IEqualityComparer<TKey> comparer) => throw null;

        public TreeDictionary(IEnumerable<KeyValuePair<TKey, TValue>> collection, IEqualityComparer<TKey> comparer) => throw null;

        public TreeDictionary(int branchingFactor) => throw null;

        public TreeDictionary(int branchingFactor, IEqualityComparer<TKey> comparer) => throw null;

        public TreeDictionary(int branchingFactor, IEnumerable<KeyValuePair<TKey, TValue>> collection, IEqualityComparer<TKey> comparer) => throw null;

        public IEqualityComparer<TKey> Comparer => throw null;
