...
namespace TunnelVisionLabs.Collections.Trees.Immutable
{
    ...
    public sealed partial class ImmutableTreeDictionary<TKey, TValue> : IImmutableDictionary<TKey, TValue>, IDictionary<TKey, TValue>, IReadOnlyDictionary<TKey, TValue>, IDictionary
    {
        ...
        public ImmutableTreeDictionary<TKey, TValue> Add(TKey key, TValue value) => throw null;

        public ImmutableTreeDictionary<TKey, TValue> AddRange(IEnumerable<KeyValuePair<TKey, TValue>> pairs) => throw null;

        public ImmutableTreeDictionary<TKey, TValue> Clear() => throw null;
        ...
        public ImmutableTreeDictionary<TKey, TValue> Remove(TKey key) => throw null;

        public ImmutableTreeDictionary<TKey, TValue> RemoveRange(IEnumerable<TKey> keys) => throw null;
        ...
        public ImmutableTreeDictionary<TKey, TValue> WithComparers(IEqualityComparer<TKey> keyComparer) => throw null;
