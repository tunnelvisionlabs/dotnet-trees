...
#if true
                    Debug.Assert(_nodes.Length == 8, "Immutable collections use a fixed branching factor of 8, so the algorithm does not need to account for odd-value branching factors.");
#else
