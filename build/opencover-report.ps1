...
$target_dll = "..\TunnelVisionLabs.Collections.Trees.Test\bin\$Configuration\net452\TunnelVisionLabs.Collections.Trees.Test.dll"
...
&$opencover_console `
	...
	-returntargetcode `
	-hideskipped:All `
	-filter:"+[TunnelVisionLabs*]*" `
	-excludebyattribute:*.ExcludeFromCodeCoverage* `
	-excludebyfile:*\*Designer.cs `
	-output:"$report_folder\OpenCover.dotnet-trees.xml" `
