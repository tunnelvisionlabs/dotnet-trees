...
if (-not $SkipKeyCheck) {
	...
	foreach ($pair in $Keys.GetEnumerator()) {
		$assembly = Resolve-FullPath -Path "..\TunnelVisionLabs.Collections.Trees\bin\$BuildConfig\$($pair.Key)\TunnelVisionLabs.Collections.Trees.dll"
...
Copy-Item "..\TunnelVisionLabs.Collections.Trees\bin\$BuildConfig\TunnelVisionLabs.Collections.Trees.$Version.nupkg" 'nuget'
Copy-Item "..\TunnelVisionLabs.Collections.Trees\bin\$BuildConfig\TunnelVisionLabs.Collections.Trees.$Version.symbols.nupkg" 'nuget'
