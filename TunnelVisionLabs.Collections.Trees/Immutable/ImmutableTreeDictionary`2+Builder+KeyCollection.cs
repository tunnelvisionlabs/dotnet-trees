    ...
    public partial class ImmutableTreeDictionary<TKey, TValue>
    {
        public partial class Builder
        {
            public struct KeyCollection : ICollection<TKey>, IReadOnlyCollection<TKey>, ICollection
            {
                ...
                internal KeyCollection(ImmutableTreeDictionary<TKey, TValue>.Builder dictionary)
                {
                ...
                public ImmutableTreeDictionary<TKey, TValue>.KeyCollection.Enumerator GetEnumerator()
                    => new ImmutableTreeDictionary<TKey, TValue>.KeyCollection.Enumerator(_dictionary.GetEnumerator());
