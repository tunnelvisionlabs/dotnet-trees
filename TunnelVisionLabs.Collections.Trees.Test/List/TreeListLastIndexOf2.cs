...
namespace TunnelVisionLabs.Collections.Trees.Test.List
{
    ...
    /// <summary>
    /// Tests for <see cref="TreeList{T}.LastIndexOf(T, int)"/>, derived from tests for
    /// <see cref="List{T}.LastIndexOf(T, int)"/> in dotnet/coreclr.
    /// </summary>
    public class TreeListLastIndexOf2
    {
        ...
        public void NegTest1()
        {
            ...
            TreeList<int> listObject = new TreeList<int>(iArray);
            Assert.Throws<ArgumentOutOfRangeException>(() => listObject.LastIndexOf(-11, -4));
        }
        ...
        public void NegTest2()
        {
            int[] iArray = { 1, 9, -11, 3, 6, -1, 8, 7, 1, 2, 4 };
            TreeList<int> listObject = new TreeList<int>(iArray);
            Assert.Throws<ArgumentOutOfRangeException>(() => listObject.LastIndexOf(-11, 12));
        }
