...
namespace TunnelVisionLabs.Collections.Trees.Test.Immutable
{
    ...
    public class ImmutableSortedTreeDictionaryBuilderTest
    {
        [Fact]
...
#pragma warning restore xUnit2017 // Do not use Contains() to check if a value exists in a collection
        ...
        {
            Assert.Same(Comparer<object>.Default, ImmutableSortedTreeDictionary.CreateBuilder<object, object>().KeyComparer);
            Assert.Same(EqualityComparer<object>.Default, ImmutableSortedTreeDictionary.CreateBuilder<object, object>().ValueComparer);
            Assert.Same(Comparer<int>.Default, ImmutableSortedTreeDictionary.CreateBuilder<int, int>().KeyComparer);
            Assert.Same(EqualityComparer<int>.Default, ImmutableSortedTreeDictionary.CreateBuilder<int, int>().ValueComparer);
            Assert.Same(Comparer<IComparable>.Default, ImmutableSortedTreeDictionary.CreateBuilder<IComparable, IComparable>().KeyComparer);
            Assert.Same(EqualityComparer<IComparable>.Default, ImmutableSortedTreeDictionary.CreateBuilder<IComparable, IComparable>().ValueComparer);

            Assert.Same(Comparer<object>.Default, ImmutableSortedTreeDictionary.CreateRange<object, object>(Enumerable.Empty<KeyValuePair<object, object>>()).ToBuilder().KeyComparer);
            Assert.Same(EqualityComparer<object>.Default, ImmutableSortedTreeDictionary.CreateRange<object, object>(Enumerable.Empty<KeyValuePair<object, object>>()).ToBuilder().ValueComparer);
            Assert.Same(Comparer<int>.Default, ImmutableSortedTreeDictionary.CreateRange<int, int>(Enumerable.Empty<KeyValuePair<int, int>>()).ToBuilder().KeyComparer);
            Assert.Same(EqualityComparer<int>.Default, ImmutableSortedTreeDictionary.CreateRange<int, int>(Enumerable.Empty<KeyValuePair<int, int>>()).ToBuilder().ValueComparer);
            Assert.Same(Comparer<IComparable>.Default, ImmutableSortedTreeDictionary.CreateRange<IComparable, IComparable>(Enumerable.Empty<KeyValuePair<IComparable, IComparable>>()).ToBuilder().KeyComparer);
            Assert.Same(EqualityComparer<IComparable>.Default, ImmutableSortedTreeDictionary.CreateRange<IComparable, IComparable>(Enumerable.Empty<KeyValuePair<IComparable, IComparable>>()).ToBuilder().ValueComparer);

            Assert.Same(Comparer<object>.Default, ImmutableSortedTreeDictionary.CreateBuilder<object, object>(keyComparer: null).KeyComparer);
            Assert.Same(EqualityComparer<object>.Default, ImmutableSortedTreeDictionary.CreateBuilder<object, object>(keyComparer: null).ValueComparer);
            Assert.Same(Comparer<int>.Default, ImmutableSortedTreeDictionary.CreateBuilder<int, int>(keyComparer: null).KeyComparer);
            Assert.Same(EqualityComparer<int>.Default, ImmutableSortedTreeDictionary.CreateBuilder<int, int>(keyComparer: null).ValueComparer);
            Assert.Same(Comparer<IComparable>.Default, ImmutableSortedTreeDictionary.CreateBuilder<IComparable, IComparable>(keyComparer: null).KeyComparer);
            Assert.Same(EqualityComparer<IComparable>.Default, ImmutableSortedTreeDictionary.CreateBuilder<IComparable, IComparable>(keyComparer: null).ValueComparer);

            Assert.Same(Comparer<object>.Default, ImmutableSortedTreeDictionary.CreateRange<object, object>(keyComparer: null, Enumerable.Empty<KeyValuePair<object, object>>()).ToBuilder().KeyComparer);
            Assert.Same(EqualityComparer<object>.Default, ImmutableSortedTreeDictionary.CreateRange<object, object>(keyComparer: null, Enumerable.Empty<KeyValuePair<object, object>>()).ToBuilder().ValueComparer);
            Assert.Same(Comparer<int>.Default, ImmutableSortedTreeDictionary.CreateRange<int, int>(keyComparer: null, Enumerable.Empty<KeyValuePair<int, int>>()).ToBuilder().KeyComparer);
            Assert.Same(EqualityComparer<int>.Default, ImmutableSortedTreeDictionary.CreateRange<int, int>(keyComparer: null, Enumerable.Empty<KeyValuePair<int, int>>()).ToBuilder().ValueComparer);
            Assert.Same(Comparer<IComparable>.Default, ImmutableSortedTreeDictionary.CreateRange<IComparable, IComparable>(keyComparer: null, Enumerable.Empty<KeyValuePair<IComparable, IComparable>>()).ToBuilder().KeyComparer);
            Assert.Same(EqualityComparer<IComparable>.Default, ImmutableSortedTreeDictionary.CreateRange<IComparable, IComparable>(keyComparer: null, Enumerable.Empty<KeyValuePair<IComparable, IComparable>>()).ToBuilder().ValueComparer);

            Assert.Same(Comparer<object>.Default, ImmutableSortedTreeDictionary.CreateBuilder<object, object>(keyComparer: null, valueComparer: null).KeyComparer);
            Assert.Same(EqualityComparer<object>.Default, ImmutableSortedTreeDictionary.CreateBuilder<object, object>(keyComparer: null, valueComparer: null).ValueComparer);
            Assert.Same(Comparer<int>.Default, ImmutableSortedTreeDictionary.CreateBuilder<int, int>(keyComparer: null, valueComparer: null).KeyComparer);
            Assert.Same(EqualityComparer<int>.Default, ImmutableSortedTreeDictionary.CreateBuilder<int, int>(keyComparer: null, valueComparer: null).ValueComparer);
            Assert.Same(Comparer<IComparable>.Default, ImmutableSortedTreeDictionary.CreateBuilder<IComparable, IComparable>(keyComparer: null, valueComparer: null).KeyComparer);
            Assert.Same(EqualityComparer<IComparable>.Default, ImmutableSortedTreeDictionary.CreateBuilder<IComparable, IComparable>(keyComparer: null, valueComparer: null).ValueComparer);

            Assert.Same(Comparer<object>.Default, ImmutableSortedTreeDictionary.CreateRange<object, object>(keyComparer: null, valueComparer: null, Enumerable.Empty<KeyValuePair<object, object>>()).ToBuilder().KeyComparer);
            Assert.Same(EqualityComparer<object>.Default, ImmutableSortedTreeDictionary.CreateRange<object, object>(keyComparer: null, valueComparer: null, Enumerable.Empty<KeyValuePair<object, object>>()).ToBuilder().ValueComparer);
            Assert.Same(Comparer<int>.Default, ImmutableSortedTreeDictionary.CreateRange<int, int>(keyComparer: null, valueComparer: null, Enumerable.Empty<KeyValuePair<int, int>>()).ToBuilder().KeyComparer);
            Assert.Same(EqualityComparer<int>.Default, ImmutableSortedTreeDictionary.CreateRange<int, int>(keyComparer: null, valueComparer: null, Enumerable.Empty<KeyValuePair<int, int>>()).ToBuilder().ValueComparer);
            Assert.Same(Comparer<IComparable>.Default, ImmutableSortedTreeDictionary.CreateRange<IComparable, IComparable>(keyComparer: null, valueComparer: null, Enumerable.Empty<KeyValuePair<IComparable, IComparable>>()).ToBuilder().KeyComparer);
            Assert.Same(EqualityComparer<IComparable>.Default, ImmutableSortedTreeDictionary.CreateRange<IComparable, IComparable>(keyComparer: null, valueComparer: null, Enumerable.Empty<KeyValuePair<IComparable, IComparable>>()).ToBuilder().ValueComparer);
        }
        ...
        public void TestExplicitComparer()
        {
            ...
            Assert.Same(objComparer, ImmutableSortedTreeDictionary.CreateBuilder<object, object>(keyComparer: objComparer).KeyComparer);
            Assert.Same(intComparer, ImmutableSortedTreeDictionary.CreateBuilder<int, int>(keyComparer: intComparer).KeyComparer);
            Assert.Same(comparableComparer, ImmutableSortedTreeDictionary.CreateBuilder<IComparable, IComparable>(keyComparer: comparableComparer).KeyComparer);

            Assert.Same(objComparer, ImmutableSortedTreeDictionary.CreateRange<object, object>(keyComparer: objComparer, Enumerable.Empty<KeyValuePair<object, object>>()).ToBuilder().KeyComparer);
            Assert.Same(intComparer, ImmutableSortedTreeDictionary.CreateRange<int, int>(keyComparer: intComparer, Enumerable.Empty<KeyValuePair<int, int>>()).ToBuilder().KeyComparer);
            Assert.Same(comparableComparer, ImmutableSortedTreeDictionary.CreateRange<IComparable, IComparable>(keyComparer: comparableComparer, Enumerable.Empty<KeyValuePair<IComparable, IComparable>>()).ToBuilder().KeyComparer);
        }
    }
}
